...
You will need to have a Git clone of the extension for this with the Composer
...
You will need to provide those credentials as environment variables when running
