...
final class CacheNullifyerTest extends FunctionalTestCase
{
     ...
     */
    public function setAllCoreCachesSetsAllCachesForVersion10(string $identifier): void
    {
        if ((new Typo3Version())->getMajorVersion() !== 10) {
            self::markTestSkipped('This test is only for TYPO3 v10.');
        }
     ...
     * @dataProvider coreCachesVersion10DataProvider
     */
    public function setAllCoreCachesSetsACacheFrontendForAllCachesForVersion10(string $identifier): void
    {
        if ((new Typo3Version())->getMajorVersion() !== 10) {
            self::markTestSkipped('This test is only for TYPO3 v10.');
        }
     ...
     * @dataProvider coreCachesVersion10DataProvider
     */
    public function setAllCoreCachesSetsACacheBackendForAllCachesForVersion10(string $identifier): void
    {
        if ((new Typo3Version())->getMajorVersion() !== 10) {
            self::markTestSkipped('This test is only for TYPO3 v10.');
        }
