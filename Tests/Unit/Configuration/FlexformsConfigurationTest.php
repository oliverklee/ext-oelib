...
final class FlexformsConfigurationTest extends UnitTestCase
{
     ...
     * @test
     */
    public function getAsStringForExistingNonEmptyFieldInXmlReturnsValueFromField()
    {
        $key = 'flavor';
        $value = 'hazelnut';
     ...
     */
    public function getAsStringForExistingNonEmptyFieldInArrayReturnsValueFromField(array $data)
    {
     ...
     * @test
     */
    public function getAsIntegerForExistingNonEmptyFieldInXmlReturnsValueFromField()
    {
        $key = 'size';
        $value = 4;
     ...
     */
    public function getAsIntegerForExistingNonEmptyFieldInArrayReturnsValueFromField(array $data)
    {
        $subject = new FlexformsConfiguration($this->buildContentObjectWithArrayFlexformsData($data));
     ...
     * @test
     */
    public function getAsBooleanForExistingNonEmptyFieldInXmlReturnsValueFromField()
    {
        $key = 'hasCats';
     ...
     */
    public function getAsBooleanForExistingNonEmptyFieldInArrayReturnsValueFromField(array $data)
    {
        $subject = new FlexformsConfiguration($this->buildContentObjectWithArrayFlexformsData($data));
